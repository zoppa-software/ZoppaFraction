...
Public Class FractiobTest
    ...
    Sub AddTest()
        ...
        Dim a2 = CFra(123.4).Add(Fraction.Create(2, 3))
    ...
    Sub SubtractionTest()
        ...
        Dim a2 = CFra(15).Subtraction(Fraction.Create(1, 2))
    ...
    Sub MultiplicationTest()
        ...
        Dim a2 = (-CFra(15)).Multiplication(Fraction.Create(-1, 2))
    ...
    Sub DivisionTest()
        ...
        Dim a2 = (-CFra(6)).Division(Fraction.Create(-3))
        Assert.Equal(CDbl(a2), 2)
    End Sub

    <Fact>
    Sub EqualsTest()
        Dim a1_1 = Fraction.Create(2, 6)
        Dim a1_2 = Fraction.Create(6, 18)
        Assert.Equal(a1_1, a1_2)

        Dim a1_3 = Fraction.Create(2, 7)
