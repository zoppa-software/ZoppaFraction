...
''' <summary>分数。</summary>
Public Structure FractionOld
    Implements IEquatable(Of FractionOld), IComparable, IComparable(Of FractionOld)
    ...
    ''' <returns>0値。</returns>
    Public Shared ReadOnly Property Zero As FractionOld
        Get
            Return New FractionOld(0, 1)
        End Get
    End Property

    ''' <summary>最大値を取得します。</summary>
    ''' <returns>最大値。</returns>
    Public Shared ReadOnly Property MaxValue As FractionOld
        Get
            Return New FractionOld(Integer.MaxValue - 1, 1)
        End Get
    End Property

    ''' <summary>最小値を取得します。</summary>
    ''' <returns>最小値。</returns>
    Public Shared ReadOnly Property MinValue As FractionOld
        Get
            Return New FractionOld(Integer.MinValue + 1, 1)
        End Get
    End Property
    ...
    ''' <returns>分数。</returns>
    Public Shared Function Create(num As Double) As FractionOld
        ...
        If numerator <> 0 Then
            ...
            Return New FractionOld(CInt(numerator \ divisor), CUInt(c \ divisor))
        Else
    ...
    ''' <param name="den">分母。</param>
    ''' <returns>分数。</returns>
    Public Shared Function Create(num As Integer, Optional den As UInteger = 1) As FractionOld
        If den <> 0 Then
            If num <> 0 Then
                If den <> 1 Then
    ...
    Private Shared Function RoundFraction(numerator As Long,
                                          denominator As Long,
                                          divisor As Long) As FractionOld
        ' 桁を調整
        ...
        If denominator <> 0 Then
            Return New FractionOld(CInt(numerator \ divisor), CUInt(denominator \ divisor))
        Else
...
#Region "Add"
    ...
    Public Function Add(other As FractionOld) As FractionOld
        Return (Me + other)
    End Function
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>加算結果。</returns>
    Public Shared Operator +(lf As FractionOld, rt As FractionOld) As FractionOld
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>加算結果。</returns>
    Public Shared Operator +(lf As FractionOld, rt As Integer) As FractionOld
        Return lf + FractionOld.Create(rt)
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>加算結果。</returns>
    Public Shared Operator +(lf As FractionOld, rt As Double) As FractionOld
        Return lf + FractionOld.Create(rt)
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>加算結果。</returns>
    Public Shared Operator +(lf As Integer, rt As FractionOld) As FractionOld
        Return FractionOld.Create(lf) + rt
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>加算結果。</returns>
    Public Shared Operator +(lf As Double, rt As FractionOld) As FractionOld
        Return FractionOld.Create(lf) + rt
    End Operator
...
#Region "Subtraction"
    ...
    Public Shared Operator -(self As FractionOld) As FractionOld
        Return New FractionOld(-self.mNumerator, self.mDenominator)
    End Operator

    ''' <summary>数値を引算します。</summary>
    ''' <param name="other">引算する値。</param>
    ''' <returns>引算結果。</returns>
    Public Function Subtraction(other As FractionOld) As FractionOld
        Return (Me - other)
    End Function
...
#Region "Multiplication"
    ...
    Public Function Multiplication(other As FractionOld) As FractionOld
        Return (Me * other)
    End Function
...
#Region "Division"
    ...
    Public Function Division(other As FractionOld) As FractionOld
        Return (Me / other)
    End Function
...
#Region "Compare"
    ...
    ''' <returns>比較結果。</returns>
    Public Overloads Function Equals(other As FractionOld) As Boolean Implements IEquatable(Of FractionOld).Equals
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>比較結果。</returns>
    Public Shared Operator =(lf As FractionOld, rt As FractionOld) As Boolean
        Return lf.Equals(rt)
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>比較結果。</returns>
    Public Shared Operator =(lf As FractionOld, rt As Integer) As Boolean
        Return lf.Equals(FractionOld.Create(rt))
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>比較結果。</returns>
    Public Shared Operator =(lf As FractionOld, rt As Double) As Boolean
        Return lf.Equals(FractionOld.Create(rt))
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>比較結果。</returns>
    Public Shared Operator =(lf As Integer, rt As FractionOld) As Boolean
        Return FractionOld.Create(lf).Equals(rt)
    End Operator
    ...
    ''' <param name="rt">右辺値。</param>
    ''' <returns>比較結果。</returns>
    Public Shared Operator =(lf As Double, rt As FractionOld) As Boolean
        Return FractionOld.Create(lf).Equals(rt)
    End Operator
    ...
    ''' <returns>比較結果。</returns>
    Public Shared Operator <>(lf As FractionOld, rt As Integer) As Boolean
        Return Not lf.Equals(FractionOld.Create(rt))
    End Operator
    ...
    Public Function CompareTo(obj As Object) As Integer Implements IComparable.CompareTo
        If TypeOf obj Is FractionOld Then
            Return Me.CompareTo(CType(obj, FractionOld))
        Else
    ...
    ''' <param name="other">比較対象。</param>
    ''' <returns>比較結果。</returns>
    Public Function CompareTo(other As FractionOld) As Integer Implements IComparable(Of FractionOld).CompareTo
